...
export class UserControllerService {
   ...
   * @throws ApiError
   */
  public static listUserByPageUsingPost(userQueryRequest: {
    current: UnwrapRef<number>;
    phone: UnwrapRef<string>;
    sortOrder: string;
    sortField: string;
    pageSize: UnwrapRef<number>;
    id: UnwrapRef<undefined>;
    userName: UnwrapRef<string>;
    email: UnwrapRef<string>;
